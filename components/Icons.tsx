...
// CheckCircleIcon: A simple SVG checkmark inside a circle.
...
// LockClosedIcon: A simple SVG padlock icon.
...
// PlayIcon: A simple SVG play button icon.
...
// XCircleIcon: A simple SVG 'X' mark inside a circle.
...
// ArrowLeftIcon: A simple SVG left-pointing arrow icon.
...
// LogoutIcon: A simple SVG logout icon.
...
// LightbulbIcon: A simple SVG lightbulb icon.
...
// SunIcon: A simple SVG sun icon for light mode.
...
// MoonIcon: A simple SVG moon icon for dark mode.
...
// UserIcon: A simple SVG user/person icon.
...
// MailIcon: A simple SVG mail/envelope icon.
...
// CookieIcon: A simple SVG cookie icon.
export const CookieIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12.83,3.06A9,9,0,0,0,5,15.87a9,9,0,0,0,10.81,8.07,9,9,0,0,0,5.2-12.78,1,1,0,0,1-1.25-.37,1,1,0,0,1,.37-1.25,9,9,0,0,0-7.3-6.48Z" />
...
// SearchCircleIcon: A simple SVG magnifying glass in a circle.
export const SearchCircleIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 16l-1.5-1.5M10 14l4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 15l5.5 5.5" />
    </svg>
);

// DownloadIcon: A simple SVG download icon.
